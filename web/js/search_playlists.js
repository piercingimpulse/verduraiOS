...
$(function (){
   ...
   function search(){
       ...
       $.get("https://www.googleapis.com/youtube/v3/search",
           ...
           var nextPageToken = data.nextPageToken; //gets the pages of playlists
...
function getOutput(items){
   ...
   var playlistId = items.id.playlistId;
   ...
   var playlistDate = items.snippet.publishedAt;
   
    //Build Output String
    
    var outPut = '<li>' +
        '<div class = "list-left">' +
        '<a data-fancybox data-type="iframe" href="youtube://www.youtube.com/embed/'+playlistId+'"><img src="'+thumb+'"></a>' +
        '</div>' +
        '<div class ="list-right">' +
        '<h3><a data-fancybox data-type="iframe" href="youtube://www.youtube.com/embed/'+playlistId+'">'+title+'</a></h3>' +
        '<small> By <span class="ctitle">'+channelTitle+'</span> on '+playlistDate+'</small>' +
        '<p>'+description+'</p>'+
